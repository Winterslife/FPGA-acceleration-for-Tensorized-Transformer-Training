...
entity MatrixMultiplicationKernel_entry_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of MatrixMultiplicationKernel_entry_proc is 
...
attribute shreg_extract : string;
    ...
    signal c_c_write_local : STD_LOGIC;
...
begin
    ...
    c_c_din <= c;
    c_c_write <= c_c_write_local;

    c_c_write_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            c_c_write_local <= ap_const_logic_1;
        else 
            c_c_write_local <= ap_const_logic_0;
        end if; 
    end process;

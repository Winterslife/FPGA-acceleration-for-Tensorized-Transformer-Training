...
entity MatrixMultiplicationKernel_control_s_axi is
generic (
...
end entity MatrixMultiplicationKernel_control_s_axi;
...
architecture behave of MatrixMultiplicationKernel_control_s_axi is
    ...
    constant ADDR_SIZE_N_DATA_0 : INTEGER := 16#34#;
    constant ADDR_SIZE_N_CTRL   : INTEGER := 16#38#;
    constant ADDR_SIZE_K_DATA_0 : INTEGER := 16#3c#;
    constant ADDR_SIZE_K_CTRL   : INTEGER := 16#40#;
    constant ADDR_SIZE_M_DATA_0 : INTEGER := 16#44#;
    constant ADDR_SIZE_M_CTRL   : INTEGER := 16#48#;
    ...
    signal int_size_n          : UNSIGNED(31 downto 0) := (others => '0');
    signal int_size_k          : UNSIGNED(31 downto 0) := (others => '0');
    signal int_size_m          : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_SIZE_N_DATA_0 =>
                        rdata_data <= RESIZE(int_size_n(31 downto 0), 32);
                    when ADDR_SIZE_K_DATA_0 =>
                        rdata_data <= RESIZE(int_size_k(31 downto 0), 32);
                    when ADDR_SIZE_M_DATA_0 =>
                        rdata_data <= RESIZE(int_size_m(31 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    size_n               <= STD_LOGIC_VECTOR(int_size_n);
    size_k               <= STD_LOGIC_VECTOR(int_size_k);
    size_m               <= STD_LOGIC_VECTOR(int_size_m);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_size_n(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_SIZE_N_DATA_0) then
                    int_size_n(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_size_n(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_size_k(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_SIZE_K_DATA_0) then
                    int_size_k(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_size_k(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_size_m(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_SIZE_M_DATA_0) then
                    int_size_m(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_size_m(31 downto 0));
                end if;
            end if;
        end if;
    end process;

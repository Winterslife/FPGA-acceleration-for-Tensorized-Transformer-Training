...
entity MatrixMultiplicationKernel_ProcessingElement_4_Pipeline_WriteC_Flattened is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of MatrixMultiplicationKernel_ProcessingElement_4_Pipeline_WriteC_Flattened is 
...
attribute shreg_extract : string;
    ...
    signal cPipes_4_blk_n : STD_LOGIC;
    ...
    signal n1_15_fu_209_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal inner_fu_64 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal inner_21_fu_217_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_68 : STD_LOGIC_VECTOR (14 downto 0) := "000000000000000";
    signal i_14_fu_136_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal m1_fu_72 : STD_LOGIC_VECTOR (5 downto 0) := "000000";
    signal m1_7_fu_177_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal cPipes_4_read_local : STD_LOGIC;
    signal cPipes_3_din_local : STD_LOGIC_VECTOR (255 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal cPipes_3_write_local : STD_LOGIC;
    signal cBuffer_ce0_local : STD_LOGIC;
    signal tmp_9_fu_142_p4 : STD_LOGIC_VECTOR (25 downto 0);
    signal tmp_fu_164_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal icmp_ln187_fu_191_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal n1_14_fu_197_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal inner_20_fu_203_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    inner_fu_64 <= inner_21_fu_217_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    ap_block_state3_pp0_stage0_iter2_assign_proc : process(cPipes_4_empty_n, icmp_ln170_reg_272, cPipes_3_full_n)
    begin
                ap_block_state3_pp0_stage0_iter2 <= (((cPipes_3_full_n = ap_const_logic_0) and (icmp_ln170_reg_272 = ap_const_lv1_1)) or ((cPipes_3_full_n = ap_const_logic_0) and (icmp_ln170_reg_272 = ap_const_lv1_0)) or ((icmp_ln170_reg_272 = ap_const_lv1_0) and (cPipes_4_empty_n = ap_const_logic_0)));
    end process;
    ...
    cPipes_3_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, icmp_ln170_reg_272, cPipes_3_full_n, ap_block_pp0_stage0)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln170_reg_272 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln170_reg_272 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)))) then 
            cPipes_3_blk_n <= cPipes_3_full_n;
        else 
            cPipes_3_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    cPipes_3_din <= cPipes_3_din_local;

    cPipes_3_din_local_assign_proc : process(ap_enable_reg_pp0_iter2, cPipes_4_dout, icmp_ln170_reg_272, cBuffer_q0, ap_block_pp0_stage0_01001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_01001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then
            if ((icmp_ln170_reg_272 = ap_const_lv1_1)) then 
                cPipes_3_din_local <= cBuffer_q0;
            elsif ((icmp_ln170_reg_272 = ap_const_lv1_0)) then 
                cPipes_3_din_local <= cPipes_4_dout;
            else 
                cPipes_3_din_local <= "";
            end if;
        else 
            cPipes_3_din_local <= "";
        end if; 
    ...
    cPipes_3_write <= cPipes_3_write_local;

    cPipes_3_write_local_assign_proc : process(ap_enable_reg_pp0_iter2, icmp_ln170_reg_272, ap_block_pp0_stage0_11001)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln170_reg_272 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln170_reg_272 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)))) then 
            cPipes_3_write_local <= ap_const_logic_1;
        else 
            cPipes_3_write_local <= ap_const_logic_0;
        end if; 
    end process;


    cPipes_4_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, cPipes_4_empty_n, icmp_ln170_reg_272, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln170_reg_272 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            cPipes_4_blk_n <= cPipes_4_empty_n;
        else 
            cPipes_4_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    cPipes_4_read <= cPipes_4_read_local;

    cPipes_4_read_local_assign_proc : process(ap_enable_reg_pp0_iter2, icmp_ln170_reg_272, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln170_reg_272 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            cPipes_4_read_local <= ap_const_logic_1;
        else 
            cPipes_4_read_local <= ap_const_logic_0;
        end if; 
    end process;

    i_14_fu_136_p2 <= std_logic_vector(unsigned(i_fu_68) + unsigned(ap_const_lv15_1));
    icmp_ln168_fu_130_p2 <= "1" when (i_fu_68 = ap_const_lv15_7400) else "0";
    icmp_ln170_fu_152_p2 <= "1" when (tmp_9_fu_142_p4 = ap_const_lv26_0) else "0";
    icmp_ln187_fu_191_p2 <= "1" when (inner_fu_64 = ap_const_lv32_73F) else "0";
    inner_20_fu_203_p2 <= std_logic_vector(unsigned(inner_fu_64) + unsigned(ap_const_lv32_1));
    inner_21_fu_217_p3 <= 
        ap_const_lv32_0 when (icmp_ln187_fu_191_p2(0) = '1') else 
        inner_20_fu_203_p2;
    m1_7_fu_177_p2 <= std_logic_vector(unsigned(m1_fu_72) + unsigned(ap_const_lv6_1));
    n1_14_fu_197_p2 <= std_logic_vector(unsigned(n1_fu_60) + unsigned(ap_const_lv4_1));
    n1_15_fu_209_p3 <= 
        n1_14_fu_197_p2 when (icmp_ln187_fu_191_p2(0) = '1') else 
        n1_fu_60;
    tmp_9_fu_142_p4 <= inner_fu_64(31 downto 6);

...
begin
    ...
    aPipes_17_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, aPipes_17_empty_n, ap_block_pp0_stage0)
    begin
    ...
    aPipes_17_read_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    aPipes_18_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, aPipes_18_full_n, first_iter_0_reg_215, ap_block_pp0_stage0)
    begin
    ...
    aPipes_18_write_local_assign_proc : process(ap_enable_reg_pp0_iter2, first_iter_0_reg_215, ap_block_pp0_stage0_11001)
    begin
    ...
    ap_block_state3_pp0_stage0_iter2_assign_proc : process(aPipes_17_empty_n, aPipes_18_full_n, first_iter_0_reg_215)
    begin
                ap_block_state3_pp0_stage0_iter2 <= ((ap_const_logic_0 = aPipes_17_empty_n) or ((first_iter_0_reg_215 = ap_const_lv1_0) and (ap_const_logic_0 = aPipes_18_full_n)));
    end process;
    ...
    icmp_ln35_fu_128_p2 <= "1" when (n1_fu_50 = ap_const_lv4_F) else "0";

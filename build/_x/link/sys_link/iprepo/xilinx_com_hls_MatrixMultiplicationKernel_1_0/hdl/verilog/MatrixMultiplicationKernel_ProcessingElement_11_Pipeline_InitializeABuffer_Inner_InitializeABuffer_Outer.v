...
module MatrixMultiplicationKernel_ProcessingElement_11_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire    ap_loop_init;
reg   [4:0] n2_fu_50;
wire   [4:0] select_ln31_29_fu_146_p3;
...
assign aPipes_11_din = read_reg_210;

assign aPipes_11_write = aPipes_11_write_local;

assign add_ln3147_fu_140_p2 = (n2_fu_50 + 5'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (1'b0 == aPipes_10_empty_n);
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((first_iter_0_reg_206 == 1'd0) & (1'b0 == aPipes_11_full_n));
end
...
assign icmp_ln31_fu_103_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 9'd352) ? 1'b1 : 1'b0);

assign icmp_ln35_fu_126_p2 = ((n1_fu_46 == 5'd22) ? 1'b1 : 1'b0);

assign select_ln31_29_fu_146_p3 = ((icmp_ln35_fu_126_p2[0:0] == 1'b1) ? add_ln3147_fu_140_p2 : n2_fu_50);

assign select_ln31_fu_132_p3 = ((icmp_ln35_fu_126_p2[0:0] == 1'b1) ? 5'd0 : n1_fu_46);

assign zext_ln31_fu_160_p1 = select_ln31_29_fu_146_p3;

endmodule //MatrixMultiplicationKernel_ProcessingElement_11_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer

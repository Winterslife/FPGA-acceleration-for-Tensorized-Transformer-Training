...
entity MatrixMultiplicationKernel_start_for_WriteC_U0 is 
    generic (
...
architecture rtl of MatrixMultiplicationKernel_start_for_WriteC_U0 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component MatrixMultiplicationKernel_start_for_WriteC_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 6);
...
begin
----------------------- Instantiation -----------------------
    U_MatrixMultiplicationKernel_start_for_WriteC_U0_ShiftReg : MatrixMultiplicationKernel_start_for_WriteC_U0_ShiftReg
    generic map (
...
entity MatrixMultiplicationKernel_start_for_WriteC_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 6);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end MatrixMultiplicationKernel_start_for_WriteC_U0_ShiftReg;

architecture rtl of MatrixMultiplicationKernel_start_for_WriteC_U0_ShiftReg is

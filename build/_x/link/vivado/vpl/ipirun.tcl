...
set kernel_ip_dirs [list \
 "$vpp_link_root/int/xo/ip_repo/xilinx_com_hls_MatrixMultiplicationKernel_1_0"]
...
set config_info [dict create \
  ...
  run_script_map_file      "" \
  clbinary_name            "MatrixMultiplication_hw" \
  kernels                  "MatrixMultiplicationKernel" \
  steps_log                 $steps_log \
  impl_from_step           "" \
  impl_to_step             "" \
  num_jobs_synth            6 \
  ...
  no_ip_cache               false \
  remote_ip_cache          "/home/minghe/gemm_hls/build/.ipcache" \
  user_board_repo           {} \
  user_bconn                {} \

...
wire    ap_loop_init;
reg   [4:0] n2_fu_50;
wire   [4:0] select_ln31_23_fu_146_p3;
...
assign aPipes_17_din = read_reg_210;
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (1'b0 == aPipes_16_empty_n);
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((first_iter_0_reg_206 == 1'd0) & (1'b0 == aPipes_17_full_n));
end
...
assign icmp_ln31_fu_103_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln35_fu_126_p2 = ((n1_fu_46 == 5'd16) ? 1'b1 : 1'b0);

assign select_ln31_23_fu_146_p3 = ((icmp_ln35_fu_126_p2[0:0] == 1'b1) ? add_ln3147_fu_140_p2 : n2_fu_50);

assign select_ln31_fu_132_p3 = ((icmp_ln35_fu_126_p2[0:0] == 1'b1) ? 5'd0 : n1_fu_46);

assign zext_ln31_fu_160_p1 = select_ln31_23_fu_146_p3;

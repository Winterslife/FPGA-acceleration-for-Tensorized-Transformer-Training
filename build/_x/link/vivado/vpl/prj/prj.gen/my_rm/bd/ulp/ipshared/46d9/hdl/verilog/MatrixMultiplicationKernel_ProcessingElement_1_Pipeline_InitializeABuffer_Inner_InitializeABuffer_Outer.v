...
module MatrixMultiplicationKernel_ProcessingElement_1_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] first_iter_0_fu_158_p2;
reg   [31:0] read_reg_214;
wire   [63:0] zext_ln31_fu_164_p1;
reg   [5:0] n1_fu_50;
wire   [5:0] add_ln35_fu_169_p2;
wire    ap_loop_init;
reg   [4:0] n2_fu_54;
wire   [4:0] select_ln31_20_fu_150_p3;
reg   [9:0] indvar_flatten_fu_58;
wire   [9:0] add_ln31_fu_113_p2;
...
wire   [0:0] icmp_ln35_fu_130_p2;
wire   [4:0] add_ln3147_fu_144_p2;
wire   [5:0] select_ln31_fu_136_p3;
reg    ap_done_reg;
...
always @ (*) begin
    if (((first_iter_0_fu_158_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (first_iter_0_reg_210 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (first_iter_0_reg_210 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
assign aBuffer_address0 = zext_ln31_fu_164_p1;
...
assign aPipes_1_din = read_reg_214;

assign aPipes_1_write = aPipes_1_write_local;

assign add_ln3147_fu_144_p2 = (n2_fu_54 + 5'd1);

assign add_ln31_fu_113_p2 = (ap_sig_allocacmp_indvar_flatten_load + 10'd1);

assign add_ln35_fu_169_p2 = (select_ln31_fu_136_p3 + 6'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (1'b0 == aPipes_0_empty_n);
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((first_iter_0_reg_210 == 1'd0) & (1'b0 == aPipes_1_full_n));
end
...
assign first_iter_0_fu_158_p2 = ((select_ln31_fu_136_p3 == 6'd0) ? 1'b1 : 1'b0);

assign icmp_ln31_fu_107_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 10'd512) ? 1'b1 : 1'b0);

assign icmp_ln35_fu_130_p2 = ((n1_fu_50 == 6'd32) ? 1'b1 : 1'b0);

assign select_ln31_20_fu_150_p3 = ((icmp_ln35_fu_130_p2[0:0] == 1'b1) ? add_ln3147_fu_144_p2 : n2_fu_54);

assign select_ln31_fu_136_p3 = ((icmp_ln35_fu_130_p2[0:0] == 1'b1) ? 6'd0 : n1_fu_50);

assign zext_ln31_fu_164_p1 = select_ln31_20_fu_150_p3;

endmodule //MatrixMultiplicationKernel_ProcessingElement_1_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer

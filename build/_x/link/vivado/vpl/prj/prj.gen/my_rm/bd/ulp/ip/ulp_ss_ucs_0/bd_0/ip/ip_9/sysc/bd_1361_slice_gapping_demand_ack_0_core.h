...
#ifndef _bd_1361_slice_gapping_demand_ack_0_core_h_
#define _bd_1361_slice_gapping_demand_ack_0_core_h_

#include <systemc.h>
#include "properties.h"


class bd_1361_slice_gapping_demand_ack_0_core : public sc_module 
{
    public: 
       bd_1361_slice_gapping_demand_ack_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(bd_1361_slice_gapping_demand_ack_0_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~bd_1361_slice_gapping_demand_ack_0_core() = default;

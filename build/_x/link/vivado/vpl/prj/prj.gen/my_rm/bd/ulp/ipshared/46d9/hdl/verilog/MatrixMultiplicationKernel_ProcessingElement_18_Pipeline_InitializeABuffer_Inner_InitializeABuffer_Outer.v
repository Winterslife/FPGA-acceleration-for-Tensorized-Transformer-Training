...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((1'b0 == aPipes_17_empty_n) | ((first_iter_0_reg_215 == 1'd0) & (1'b0 == aPipes_18_full_n)));
end
...
assign icmp_ln35_fu_128_p2 = ((n1_fu_50 == 4'd15) ? 1'b1 : 1'b0);

assign select_ln31_22_fu_168_p3 = ((icmp_ln35_reg_210[0:0] == 1'b1) ? add_ln3147_fu_162_p2 : n2_fu_54);

...
module MatrixMultiplicationKernel_ProcessingElement_4_Pipeline_WriteC_Flattened (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [3:0] n1_fu_60;
wire   [3:0] n1_15_fu_209_p3;
wire    ap_loop_init;
reg   [31:0] inner_fu_64;
wire   [31:0] inner_21_fu_217_p3;
reg   [14:0] i_fu_68;
wire   [14:0] i_14_fu_136_p2;
reg   [5:0] m1_fu_72;
wire   [5:0] m1_7_fu_177_p2;
reg    cPipes_4_read_local;
reg   [255:0] cPipes_3_din_local;
reg    ap_block_pp0_stage0_01001;
reg    cPipes_3_write_local;
reg    cBuffer_ce0_local;
wire   [25:0] tmp_9_fu_142_p4;
wire   [9:0] tmp_fu_164_p3;
wire   [0:0] icmp_ln187_fu_191_p2;
wire   [3:0] n1_14_fu_197_p2;
wire   [31:0] inner_20_fu_203_p2;
reg    ap_done_reg;
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln170_reg_272 == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln170_reg_272 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
        cPipes_3_write_local = 1'b1;
    end else begin
        cPipes_3_write_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln170_reg_272 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        cPipes_4_read_local = 1'b1;
    end else begin
        cPipes_4_read_local = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (((cPipes_3_full_n == 1'b0) & (icmp_ln170_reg_272 == 1'd1)) | ((cPipes_3_full_n == 1'b0) & (icmp_ln170_reg_272 == 1'd0)) | ((icmp_ln170_reg_272 == 1'd0) & (cPipes_4_empty_n == 1'b0)));
end
...
assign cPipes_3_din = cPipes_3_din_local;

assign cPipes_3_write = cPipes_3_write_local;

assign cPipes_4_read = cPipes_4_read_local;

assign i_14_fu_136_p2 = (i_fu_68 + 15'd1);

assign icmp_ln168_fu_130_p2 = ((i_fu_68 == 15'd29696) ? 1'b1 : 1'b0);

assign icmp_ln170_fu_152_p2 = ((tmp_9_fu_142_p4 == 26'd0) ? 1'b1 : 1'b0);

assign icmp_ln187_fu_191_p2 = ((inner_fu_64 == 32'd1855) ? 1'b1 : 1'b0);

assign inner_20_fu_203_p2 = (inner_fu_64 + 32'd1);

assign inner_21_fu_217_p3 = ((icmp_ln187_fu_191_p2[0:0] == 1'b1) ? 32'd0 : inner_20_fu_203_p2);

assign m1_7_fu_177_p2 = (m1_fu_72 + 6'd1);

assign n1_14_fu_197_p2 = (n1_fu_60 + 4'd1);

assign n1_15_fu_209_p3 = ((icmp_ln187_fu_191_p2[0:0] == 1'b1) ? n1_14_fu_197_p2 : n1_fu_60);

assign tmp_9_fu_142_p4 = {{inner_fu_64[31:6]}};

assign tmp_fu_164_p3 = {{n1_fu_60}, {m1_fu_72}};

assign zext_ln171_fu_172_p1 = tmp_fu_164_p3;

endmodule //MatrixMultiplicationKernel_ProcessingElement_4_Pipeline_WriteC_Flattened

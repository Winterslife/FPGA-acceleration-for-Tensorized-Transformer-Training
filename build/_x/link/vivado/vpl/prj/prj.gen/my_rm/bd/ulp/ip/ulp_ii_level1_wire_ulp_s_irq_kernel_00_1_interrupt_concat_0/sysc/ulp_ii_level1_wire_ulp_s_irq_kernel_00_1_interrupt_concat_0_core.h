...
#ifndef _ulp_ii_level1_wire_ulp_s_irq_kernel_00_1_interrupt_concat_0_core_h_
#define _ulp_ii_level1_wire_ulp_s_irq_kernel_00_1_interrupt_concat_0_core_h_
...
class ulp_ii_level1_wire_ulp_s_irq_kernel_00_1_interrupt_concat_0_core : public sc_module 
{
    public: 
       ulp_ii_level1_wire_ulp_s_irq_kernel_00_1_interrupt_concat_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              ...
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(ulp_ii_level1_wire_ulp_s_irq_kernel_00_1_interrupt_concat_0_core);
    ...
    virtual ~ulp_ii_level1_wire_ulp_s_irq_kernel_00_1_interrupt_concat_0_core() = default;

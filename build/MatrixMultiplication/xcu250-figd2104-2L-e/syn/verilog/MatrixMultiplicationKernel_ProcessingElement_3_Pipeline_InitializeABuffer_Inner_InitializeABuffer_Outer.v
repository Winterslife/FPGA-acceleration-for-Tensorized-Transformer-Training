...
reg   [4:0] n2_fu_50;
wire   [4:0] select_ln31_7_fu_164_p3;
...
assign add_ln31_7_fu_158_p2 = (n2_fu_50 + 5'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((1'b0 == aPipes_2_empty_n) | ((first_iter_0_reg_210 == 1'd0) & (1'b0 == aPipes_3_full_n)));
end
...
assign icmp_ln31_fu_104_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 9'd480) ? 1'b1 : 1'b0);

assign icmp_ln35_fu_119_p2 = ((ap_sig_allocacmp_n1_load == 5'd30) ? 1'b1 : 1'b0);

assign select_ln31_7_fu_164_p3 = ((icmp_ln35_reg_205[0:0] == 1'b1) ? add_ln31_7_fu_158_p2 : n2_fu_50);

assign select_ln31_fu_125_p3 = ((icmp_ln35_fu_119_p2[0:0] == 1'b1) ? 5'd0 : ap_sig_allocacmp_n1_load);

assign zext_ln31_fu_171_p1 = select_ln31_7_fu_164_p3;

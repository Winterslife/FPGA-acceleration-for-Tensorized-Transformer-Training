...
module MatrixMultiplicationKernel_ProcessingElement_19_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [3:0] n1_fu_50;
wire   [3:0] add_ln35_fu_143_p2;
wire    ap_loop_init;
reg   [3:0] ap_sig_allocacmp_n1_load;
reg   [4:0] n2_fu_54;
wire   [4:0] select_ln31_21_fu_168_p3;
...
wire   [3:0] select_ln31_fu_129_p3;
...
assign add_ln35_fu_143_p2 = (select_ln31_fu_129_p3 + 4'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((1'b0 == aPipes_18_empty_n) | ((first_iter_0_reg_214 == 1'd0) & (1'b0 == aPipes_19_full_n)));
end
...
assign first_iter_0_fu_137_p2 = ((select_ln31_fu_129_p3 == 4'd0) ? 1'b1 : 1'b0);

assign icmp_ln31_fu_108_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 8'd224) ? 1'b1 : 1'b0);

assign icmp_ln35_fu_123_p2 = ((ap_sig_allocacmp_n1_load == 4'd14) ? 1'b1 : 1'b0);

assign select_ln31_21_fu_168_p3 = ((icmp_ln35_reg_209[0:0] == 1'b1) ? add_ln3147_fu_162_p2 : n2_fu_54);

assign select_ln31_fu_129_p3 = ((icmp_ln35_fu_123_p2[0:0] == 1'b1) ? 4'd0 : ap_sig_allocacmp_n1_load);

assign zext_ln31_fu_175_p1 = select_ln31_21_fu_168_p3;

endmodule //MatrixMultiplicationKernel_ProcessingElement_19_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer

...
reg   [23:0] lshr_ln_reg_279;
reg    ap_block_state1;
reg   [23:0] lshr_ln1_reg_284;
reg   [27:0] lshr_ln2_reg_289;
wire    ap_CS_fsm_state2;
wire   [36:0] tmp_s_fu_254_p3;
reg   [36:0] tmp_s_reg_301;
wire   [59:0] bound17_fu_196_p2;
reg   [59:0] bound17_reg_306;
wire   [82:0] bound40_fu_200_p2;
reg   [82:0] bound40_reg_311;
...
wire   [23:0] bound17_fu_196_p0;
wire   [36:0] bound17_fu_196_p1;
wire   [23:0] bound40_fu_200_p0;
wire   [59:0] bound40_fu_200_p1;
...
wire   [59:0] bound17_fu_196_p00;
wire   [59:0] bound17_fu_196_p10;
wire   [82:0] bound40_fu_200_p00;
wire   [82:0] bound40_fu_200_p10;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((grp_ReadA_Pipeline_ReadA_N0_ReadA_M0_ReadA_K0_ReadA_N1_ReadA_N2_fu_152_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        tmp_s_reg_301[36 : 9] <= tmp_s_fu_254_p3[36 : 9];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        lshr_ln1_reg_284 <= {{add_ln116_fu_228_p2[32:9]}};
        lshr_ln2_reg_289 <= {{size_k[31:4]}};
        lshr_ln_reg_279 <= {{add_ln111_fu_208_p2[32:9]}};
    end
end
...
always @ (*) begin
    if (((grp_ReadA_Pipeline_ReadA_N0_ReadA_M0_ReadA_K0_ReadA_N1_ReadA_N2_fu_152_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign bound17_fu_196_p0 = bound17_fu_196_p00;

assign bound17_fu_196_p00 = lshr_ln1_reg_284;

assign bound17_fu_196_p1 = bound17_fu_196_p10;

assign bound17_fu_196_p10 = tmp_s_fu_254_p3;

assign bound40_fu_200_p0 = bound40_fu_200_p00;

assign bound40_fu_200_p00 = lshr_ln_reg_279;

assign bound40_fu_200_p1 = bound40_fu_200_p10;

assign bound40_fu_200_p10 = bound17_fu_196_p2;
...
assign tmp_s_fu_254_p3 = {{lshr_ln2_reg_289}, {9'd0}};
...
always @ (posedge ap_clk) begin
    tmp_s_reg_301[8:0] <= 9'b000000000;
end

...
module MatrixMultiplicationKernel_ProcessingElement_20_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [4:0] n2_fu_54;
wire   [4:0] select_ln31_19_fu_168_p3;
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((1'b0 == aPipes_19_empty_n) | ((first_iter_0_reg_214 == 1'd0) & (1'b0 == aPipes_20_full_n)));
end
...
assign icmp_ln31_fu_108_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 8'd208) ? 1'b1 : 1'b0);

assign icmp_ln35_fu_123_p2 = ((ap_sig_allocacmp_n1_load == 4'd13) ? 1'b1 : 1'b0);

assign select_ln31_19_fu_168_p3 = ((icmp_ln35_reg_209[0:0] == 1'b1) ? add_ln3147_fu_162_p2 : n2_fu_54);

assign select_ln31_fu_129_p3 = ((icmp_ln35_fu_123_p2[0:0] == 1'b1) ? 4'd0 : ap_sig_allocacmp_n1_load);

assign zext_ln31_fu_175_p1 = select_ln31_19_fu_168_p3;

endmodule //MatrixMultiplicationKernel_ProcessingElement_20_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer

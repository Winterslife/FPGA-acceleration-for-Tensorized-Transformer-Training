...
reg    size_k_blk_n;
reg    size_m_blk_n;
reg   [31:0] size_k_1_reg_213;
reg    ap_block_state1;
reg   [23:0] trunc_ln_reg_218;
wire   [40:0] tmp_fu_187_p3;
reg   [40:0] tmp_reg_223;
wire   [63:0] bound4_fu_138_p2;
reg   [63:0] bound4_reg_228;
wire   [86:0] bound16_fu_142_p2;
reg   [86:0] bound16_reg_234;
...
wire   [23:0] bound4_fu_138_p0;
wire   [40:0] bound4_fu_138_p1;
wire   [23:0] bound16_fu_142_p0;
wire   [63:0] bound16_fu_142_p1;
wire   [32:0] zext_ln111_fu_147_p1;
wire   [32:0] add_ln111_fu_151_p2;
wire   [32:0] zext_ln116_fu_167_p1;
wire   [32:0] add_ln116_fu_171_p2;
wire   [23:0] trunc_ln2_fu_177_p4;
reg   [2:0] ap_NS_fsm;
reg    ap_ST_fsm_state1_blk;
wire    ap_ST_fsm_state2_blk;
reg    ap_ST_fsm_state3_blk;
wire   [86:0] bound16_fu_142_p00;
wire   [86:0] bound16_fu_142_p10;
wire   [63:0] bound4_fu_138_p00;
wire   [63:0] bound4_fu_138_p10;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state3) & (grp_TransposeA_Pipeline_TransposeA_N0_TransposeA_M0_TransposeA_K_VITIS_LOOP_153_1_fu_96_ap_done == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        ...
        tmp_reg_223[40 : 9] <= tmp_fu_187_p3[40 : 9];
        trunc_ln_reg_218 <= {{add_ln111_fu_151_p2[32:9]}};
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (grp_TransposeA_Pipeline_TransposeA_N0_TransposeA_M0_TransposeA_K_VITIS_LOOP_153_1_fu_96_ap_done == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (size_m_empty_n == 1'b0) | (size_k_empty_n == 1'b0) | (size_n_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign bound16_fu_142_p0 = bound16_fu_142_p00;

assign bound16_fu_142_p00 = trunc_ln_reg_218;

assign bound16_fu_142_p1 = bound16_fu_142_p10;

assign bound16_fu_142_p10 = bound4_reg_228;

assign bound4_fu_138_p0 = bound4_fu_138_p00;

assign bound4_fu_138_p00 = trunc_ln2_fu_177_p4;

assign bound4_fu_138_p1 = bound4_fu_138_p10;

assign bound4_fu_138_p10 = tmp_fu_187_p3;
...
assign tmp_fu_187_p3 = {{size_k_dout}, {9'd0}};

assign trunc_ln2_fu_177_p4 = {{add_ln116_fu_171_p2[32:9]}};

...
entity MatrixMultiplicationKernel_ProcessingElement_31_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of MatrixMultiplicationKernel_ProcessingElement_31_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer is 
...
attribute shreg_extract : string;
    ...
    signal n1_fu_50 : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal add_ln35_fu_143_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_n1_load : STD_LOGIC_VECTOR (1 downto 0);
    signal n2_fu_54 : STD_LOGIC_VECTOR (4 downto 0) := "00000";
    signal select_ln31_7_fu_168_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal indvar_flatten_fu_58 : STD_LOGIC_VECTOR (5 downto 0) := "000000";
    signal add_ln31_7_fu_114_p2 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal select_ln31_fu_129_p3 : STD_LOGIC_VECTOR (1 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln31_fu_108_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    indvar_flatten_fu_58 <= add_ln31_7_fu_114_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    indvar_flatten_fu_58 <= ap_const_lv6_0;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    n2_fu_54 <= select_ln31_7_fu_168_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    aPipes_30_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, aPipes_30_empty_n, ap_block_pp0_stage0)
    begin
    ...
    aPipes_30_read_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    aPipes_31_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, aPipes_31_full_n, first_iter_0_reg_214, ap_block_pp0_stage0)
    begin
    ...
    aPipes_31_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, first_iter_0_reg_214, ap_block_pp0_stage0_11001)
    begin
    ...
    add_ln31_7_fu_114_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten_load) + unsigned(ap_const_lv6_1));
    add_ln35_fu_143_p2 <= std_logic_vector(unsigned(select_ln31_fu_129_p3) + unsigned(ap_const_lv2_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(aPipes_30_empty_n, aPipes_31_full_n, first_iter_0_reg_214)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((ap_const_logic_0 = aPipes_30_empty_n) or ((first_iter_0_reg_214 = ap_const_lv1_0) and (ap_const_logic_0 = aPipes_31_full_n)));
    end process;
    ...
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_n1_load <= ap_const_lv2_0;
        else 
            ap_sig_allocacmp_n1_load <= n1_fu_50;
        end if; 
    end process;

    first_iter_0_fu_137_p2 <= "1" when (select_ln31_fu_129_p3 = ap_const_lv2_0) else "0";
    icmp_ln31_fu_108_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten_load = ap_const_lv6_20) else "0";
    icmp_ln35_fu_123_p2 <= "1" when (ap_sig_allocacmp_n1_load = ap_const_lv2_2) else "0";
    select_ln31_7_fu_168_p3 <= 
        add_ln3147_fu_162_p2 when (icmp_ln35_reg_209(0) = '1') else 
        n2_fu_54;
    select_ln31_fu_129_p3 <= 
        ap_const_lv2_0 when (icmp_ln35_fu_123_p2(0) = '1') else 
        ap_sig_allocacmp_n1_load;
    zext_ln31_fu_175_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln31_7_fu_168_p3),64));
end behav;

...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler MatrixMultiplicationKernel_ProcessingElement_14_aBuffer_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler MatrixMultiplicationKernel_ProcessingElement_14_cBuffer_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { cPipes_13_din { O 256 vector } cPipes_13_num_data_valid { I 3 vector } cPipes_13_fifo_cap { I 3 vector } cPipes_13_full_n { I 1 bit } cPipes_13_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { cPipes_14_dout { I 256 vector } cPipes_14_num_data_valid { I 3 vector } cPipes_14_fifo_cap { I 3 vector } cPipes_14_empty_n { I 1 bit } cPipes_14_read { O 1 bit } } \
} "
}

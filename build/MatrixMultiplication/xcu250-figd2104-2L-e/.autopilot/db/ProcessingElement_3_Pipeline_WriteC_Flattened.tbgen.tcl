set moduleName ProcessingElement_3_Pipeline_WriteC_Flattened
set isTopModule 0
...
set C_modelName {ProcessingElement.3_Pipeline_WriteC_Flattened}
...
set portList { 
	...
	{ cPipes_3_dout sc_in sc_lv 256 signal 2 } 
	{ cPipes_3_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ cPipes_3_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ cPipes_3_empty_n sc_in sc_logic 1 signal 2 } 
	{ cPipes_3_read sc_out sc_logic 1 signal 2 } 
	{ cPipes_2_din sc_out sc_lv 256 signal 1 } 
	{ cPipes_2_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ cPipes_2_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ cPipes_2_full_n sc_in sc_logic 1 signal 1 } 
	{ cPipes_2_write sc_out sc_logic 1 signal 1 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "30722", "Max" : "30722"}
	, {"Name" : "Interval", "Min" : "30722", "Max" : "30722"}
]}

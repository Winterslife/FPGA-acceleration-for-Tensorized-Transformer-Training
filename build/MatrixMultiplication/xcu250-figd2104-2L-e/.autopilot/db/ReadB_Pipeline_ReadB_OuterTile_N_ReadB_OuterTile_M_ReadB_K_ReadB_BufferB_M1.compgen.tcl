...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_bMemory \
    op interface \
    ports { bMemory_din { O 512 vector } bMemory_num_data_valid { I 7 vector } bMemory_fifo_cap { I 7 vector } bMemory_full_n { I 1 bit } bMemory_write { O 1 bit } } \
} "
}

set moduleName FeedB_Pipeline_1
set isTopModule 0
...
set C_modelName {FeedB_Pipeline_1}
...
set C_modelArgList {
	{ buffer_r int 256 regular {array 64 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set hasAXIML2Cache 0
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "buffer_r", "interface" : "memory", "bitwidth" : 256, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ buffer_r_address0 sc_out sc_lv 6 signal 0 } 
	{ buffer_r_ce0 sc_out sc_logic 1 signal 0 } 
	{ buffer_r_we0 sc_out sc_logic 1 signal 0 } 
	{ buffer_r_d0 sc_out sc_lv 256 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	buffer_r { ap_memory {  { buffer_r_address0 mem_address 1 6 }  { buffer_r_ce0 mem_ce 1 1 }  { buffer_r_we0 mem_we 1 1 }  { buffer_r_d0 mem_din 1 256 } } }
}

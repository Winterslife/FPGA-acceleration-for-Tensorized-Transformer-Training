...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler MatrixMultiplicationKernel_ProcessingElement_6_aBuffer_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler MatrixMultiplicationKernel_ProcessingElement_6_cBuffer_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { cPipes_5_din { O 256 vector } cPipes_5_num_data_valid { I 3 vector } cPipes_5_fifo_cap { I 3 vector } cPipes_5_full_n { I 1 bit } cPipes_5_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { cPipes_6_dout { I 256 vector } cPipes_6_num_data_valid { I 3 vector } cPipes_6_fifo_cap { I 3 vector } cPipes_6_empty_n { I 1 bit } cPipes_6_read { O 1 bit } } \
} "
}

set moduleName ProcessingElement_11_Pipeline_WriteC_Flattened
set isTopModule 0
...
set C_modelName {ProcessingElement.11_Pipeline_WriteC_Flattened}
...
set portList { 
	...
	{ cPipes_11_dout sc_in sc_lv 256 signal 2 } 
	{ cPipes_11_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ cPipes_11_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ cPipes_11_empty_n sc_in sc_logic 1 signal 2 } 
	{ cPipes_11_read sc_out sc_logic 1 signal 2 } 
	{ cPipes_10_din sc_out sc_lv 256 signal 1 } 
	{ cPipes_10_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ cPipes_10_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ cPipes_10_full_n sc_in sc_logic 1 signal 1 } 
	{ cPipes_10_write sc_out sc_logic 1 signal 1 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "22530", "Max" : "22530"}
	, {"Name" : "Interval", "Min" : "22530", "Max" : "22530"}
]}

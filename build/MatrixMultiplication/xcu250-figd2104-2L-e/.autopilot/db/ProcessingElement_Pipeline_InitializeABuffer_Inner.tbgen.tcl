set moduleName ProcessingElement_Pipeline_InitializeABuffer_Inner
set isTopModule 0
...
set C_modelName {ProcessingElement_Pipeline_InitializeABuffer_Inner}
...
set portList { 
	...
	{ aBuffer_address0 sc_out sc_lv 5 signal 1 } 
	{ aBuffer_ce0 sc_out sc_logic 1 signal 1 } 
	{ aBuffer_we0 sc_out sc_logic 1 signal 1 } 
	{ aBuffer_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 

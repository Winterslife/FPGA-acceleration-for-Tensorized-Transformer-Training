set moduleName ProcessingElement_29_Pipeline_2
set isTopModule 0
...
set C_modelName {ProcessingElement.29_Pipeline_2}
...
set C_modelArgList {
	{ cBuffer int 256 regular {array 1024 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set hasAXIML2Cache 0
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "cBuffer", "interface" : "memory", "bitwidth" : 256, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ cBuffer_we0 sc_out sc_logic 1 signal 0 } 
	{ cBuffer_d0 sc_out sc_lv 256 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	cBuffer { ap_memory {  { cBuffer_address0 mem_address 1 10 }  { cBuffer_ce0 mem_ce 1 1 }  { cBuffer_we0 mem_we 1 1 }  { cBuffer_d0 mem_din 1 256 } } }
}

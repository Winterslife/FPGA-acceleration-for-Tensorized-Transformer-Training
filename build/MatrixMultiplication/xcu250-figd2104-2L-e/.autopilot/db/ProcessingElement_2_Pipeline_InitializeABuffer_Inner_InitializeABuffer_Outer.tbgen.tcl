set moduleName ProcessingElement_2_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer
set isTopModule 0
...
set C_modelName {ProcessingElement.2_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer}
...
set portList { 
	...
	{ aPipes_1_dout sc_in sc_lv 32 signal 1 } 
	{ aPipes_1_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ aPipes_1_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ aPipes_1_empty_n sc_in sc_logic 1 signal 1 } 
	{ aPipes_1_read sc_out sc_logic 1 signal 1 } 
	{ aPipes_2_din sc_out sc_lv 32 signal 2 } 
	{ aPipes_2_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ aPipes_2_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ aPipes_2_full_n sc_in sc_logic 1 signal 2 } 
	{ aPipes_2_write sc_out sc_logic 1 signal 2 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "498", "Max" : "498"}
	, {"Name" : "Interval", "Min" : "498", "Max" : "498"}
]}

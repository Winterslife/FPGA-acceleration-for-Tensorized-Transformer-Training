...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler MatrixMultiplicationKernel_ProcessingElement_8_aBuffer_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler MatrixMultiplicationKernel_ProcessingElement_8_cBuffer_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { cPipes_7_din { O 256 vector } cPipes_7_num_data_valid { I 3 vector } cPipes_7_fifo_cap { I 3 vector } cPipes_7_full_n { I 1 bit } cPipes_7_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { cPipes_8_dout { I 256 vector } cPipes_8_num_data_valid { I 3 vector } cPipes_8_fifo_cap { I 3 vector } cPipes_8_empty_n { I 1 bit } cPipes_8_read { O 1 bit } } \
} "
}

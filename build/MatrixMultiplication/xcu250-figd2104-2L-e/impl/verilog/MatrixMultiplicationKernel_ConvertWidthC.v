...
reg    size_n_c_blk_n;
reg    size_m_c_blk_n;
reg   [23:0] tmp_s_reg_164;
reg    ap_block_state1;
reg   [23:0] tmp_455_reg_169;
wire   [29:0] tmp_456_fu_146_p3;
reg   [29:0] tmp_456_reg_174;
wire    ap_CS_fsm_state2;
wire   [62:0] bound4_fu_94_p2;
reg   [62:0] bound4_reg_179;
...
wire   [32:0] bound4_fu_94_p0;
wire   [29:0] bound4_fu_94_p1;
...
wire   [62:0] bound4_fu_94_p00;
wire   [62:0] bound4_fu_94_p10;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((grp_ConvertWidthC_Pipeline_ConvertWidthC_N_ConvertWidthC_M_VITIS_LOOP_339_1_fu_84_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        tmp_456_reg_174[29 : 6] <= tmp_456_fu_146_p3[29 : 6];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_455_reg_169 <= {{sub_i2_fu_123_p2[32:9]}};
        tmp_s_reg_164 <= {{sub_i_fu_103_p2[32:9]}};
    end
end
...
always @ (*) begin
    if (((grp_ConvertWidthC_Pipeline_ConvertWidthC_N_ConvertWidthC_M_VITIS_LOOP_339_1_fu_84_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign bound4_fu_94_p0 = bound4_fu_94_p00;

assign bound4_fu_94_p00 = div_i_fu_139_p3;

assign bound4_fu_94_p1 = bound4_fu_94_p10;

assign bound4_fu_94_p10 = tmp_456_fu_146_p3;

assign cMemory_din = grp_ConvertWidthC_Pipeline_ConvertWidthC_N_ConvertWidthC_M_VITIS_LOOP_339_1_fu_84_cMemory_din;

assign div_i_fu_139_p3 = {{tmp_s_reg_164}, {9'd0}};
...
assign tmp_456_fu_146_p3 = {{tmp_455_reg_169}, {6'd0}};

always @ (posedge ap_clk) begin
    tmp_456_reg_174[5:0] <= 6'b000000;
end

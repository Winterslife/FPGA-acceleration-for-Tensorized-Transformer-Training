...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((1'b0 == aPipes_23_empty_n) | ((first_iter_0_reg_214 == 1'd0) & (1'b0 == aPipes_24_full_n)));
end
...
assign icmp_ln35_fu_123_p2 = ((ap_sig_allocacmp_n1_load == 4'd9) ? 1'b1 : 1'b0);

assign select_ln31_15_fu_168_p3 = ((icmp_ln35_reg_209[0:0] == 1'b1) ? add_ln3147_fu_162_p2 : n2_fu_54);

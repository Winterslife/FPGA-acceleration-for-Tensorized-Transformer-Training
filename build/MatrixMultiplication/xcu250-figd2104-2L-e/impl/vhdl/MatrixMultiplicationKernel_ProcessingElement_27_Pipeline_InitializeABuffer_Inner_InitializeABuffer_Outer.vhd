...
entity MatrixMultiplicationKernel_ProcessingElement_27_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of MatrixMultiplicationKernel_ProcessingElement_27_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer is 
...
attribute shreg_extract : string;
    ...
    signal select_ln31_12_fu_168_p3 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    aPipes_26_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, aPipes_26_empty_n, ap_block_pp0_stage0)
    begin
    ...
    aPipes_26_read_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    aPipes_27_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, aPipes_27_full_n, first_iter_0_reg_214, ap_block_pp0_stage0)
    begin
    ...
    aPipes_27_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, first_iter_0_reg_214, ap_block_pp0_stage0_11001)
    begin
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(aPipes_26_empty_n, aPipes_27_full_n, first_iter_0_reg_214)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((ap_const_logic_0 = aPipes_26_empty_n) or ((first_iter_0_reg_214 = ap_const_lv1_0) and (ap_const_logic_0 = aPipes_27_full_n)));
    end process;
    ...
    icmp_ln31_fu_108_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten_load = ap_const_lv7_60) else "0";
    icmp_ln35_fu_123_p2 <= "1" when (ap_sig_allocacmp_n1_load = ap_const_lv3_6) else "0";
    select_ln31_12_fu_168_p3 <= 
    ...
    zext_ln31_fu_175_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln31_12_fu_168_p3),64));
end behav;

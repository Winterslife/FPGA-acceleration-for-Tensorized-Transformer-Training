...
entity MatrixMultiplicationKernel_ProcessingElement_19_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of MatrixMultiplicationKernel_ProcessingElement_19_Pipeline_InitializeABuffer_Inner_InitializeABuffer_Outer is 
...
attribute shreg_extract : string;
    ...
    signal select_ln31_fu_129_p3 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    n2_fu_54 <= select_ln31_21_fu_168_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    aPipes_18_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, aPipes_18_empty_n, ap_block_pp0_stage0)
    begin
    ...
    aPipes_18_read_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    aPipes_19_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, aPipes_19_full_n, first_iter_0_reg_214, ap_block_pp0_stage0)
    begin
    ...
    aPipes_19_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, first_iter_0_reg_214, ap_block_pp0_stage0_11001)
    begin
    ...
    add_ln35_fu_143_p2 <= std_logic_vector(unsigned(select_ln31_fu_129_p3) + unsigned(ap_const_lv4_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(aPipes_18_empty_n, aPipes_19_full_n, first_iter_0_reg_214)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((ap_const_logic_0 = aPipes_18_empty_n) or ((first_iter_0_reg_214 = ap_const_lv1_0) and (ap_const_logic_0 = aPipes_19_full_n)));
    end process;
    ...
    first_iter_0_fu_137_p2 <= "1" when (select_ln31_fu_129_p3 = ap_const_lv4_0) else "0";
    icmp_ln31_fu_108_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten_load = ap_const_lv8_E0) else "0";
    icmp_ln35_fu_123_p2 <= "1" when (ap_sig_allocacmp_n1_load = ap_const_lv4_E) else "0";
    select_ln31_21_fu_168_p3 <= 
        add_ln3147_fu_162_p2 when (icmp_ln35_reg_209(0) = '1') else 
        n2_fu_54;
    select_ln31_fu_129_p3 <= 
        ap_const_lv4_0 when (icmp_ln35_fu_123_p2(0) = '1') else 
        ap_sig_allocacmp_n1_load;
    zext_ln31_fu_175_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln31_21_fu_168_p3),64));
end behav;
